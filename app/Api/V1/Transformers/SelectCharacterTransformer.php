 ...
 */
class SelectCharacterTransformer extends TransformerAbstract
{
    ...
    public function transform(SelectCharacter $selectcharacter)
    {
        ...
        return [
            'id' => $selectcharacter->id,
            'character_id' => $selectcharacter->select_character,
            'total_own' => $totalOwn,
            'total_want' => $totalWant,
            'status_id' => $selectcharacter->status_id
        ];
    }
}